...
public class DishUtility {
	public static ArrayList<Dish> createAndGetDishList() {
		...
		dishList.add(new Dish("french fries", true, 530, Type.OTHER));
		dishList.add(new Dish("rice", true, 350, Type.OTHER));
		dishList.add(new Dish("season fruit", true, 120, Type.OTHER));
		dishList.add(new Dish("pizza", true, 550, Type.OTHER));
